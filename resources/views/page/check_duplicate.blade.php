@extends('layouts.app')
@section('pagename')
รายการข้อมูลซ้ำ {{-- {{ @$hosp_id ?? '' }}--}}  {{ $hosp_name->name ?? "ทั้งหมด" }} | เดือน :
<?php
$m_w = sprintf("%02d",@$mm) ;
...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row search-row" >
            <div class="col-12">
                <form  name="frm1" method="POST" action="{{ url('/check_duplicate/process') }}">
                    {{csrf_field()}}
                    <div class="form-row">
...
{{--                                <option value="ALL" {{ @$hosp_id == 'ALL' ? "selected" : "" }}>ทุกโรงพยาบาล(Admin)</option>--}}
        ...
        @if(isset($isData) )
            <h3 class="text-center">รายการข้อมูลซ้ำ {{-- {{ @$hosp_id ?? '' }}--}}  {{ $hosp_name->name ?? "" }} {{ $hosp_id == 'ALL' ? "ทั้งหมด" : "" }} | เดือน : <?php
            ...
            <div class="row table-row">
                ...
                <div class="col-12">
                    ...
                    <div class="clearfix">
                        <div style="float: left;" > <h5> (เช็คจาก PID และ HN ) </h5></div>
